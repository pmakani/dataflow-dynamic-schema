...
/**
 * A {@link DoFn} that converts a {@link PubsubMessage} with an Json payload to a {@link
 * TableRowWithSchema} object.
 *
 * <p>The schema for the {@link TableRow} is inferred by inspecting and converting the Json message
 * schema. By default, you must need to set output table
